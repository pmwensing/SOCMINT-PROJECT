...
product-blueprint-wave2-smoke:
	PYTHONPATH=src python3 scripts/product_blueprint_wave2_smoke_v10_0_9.py

test1009:
	PYTHONPATH=src python3 scripts/product_blueprint_wave2_smoke_v10_0_9.py

blueprint-wave2-hardening-smoke:
...
test121031C:
	bash scripts/test_v12_10_31C.sh

report121031C:
	python scripts/drift_lock_audit_v12_10_31A.py || true
	@echo 'Report: release/drift_lock/DRIFT_LOCK_AUDIT_V12_10_31C.md'

test121031D:
	bash scripts/test_v12_10_31D.sh

report121031D:
	python scripts/drift_lock_audit_v12_10_31A.py || true
	@echo 'Report: release/drift_lock/DRIFT_LOCK_AUDIT_V12_10_31D.md'

test121031E:
	bash scripts/test_v12_10_31E.sh

report121031E:
	python scripts/drift_lock_audit_v12_10_31A.py || true
	@echo 'Report: release/drift_lock/DRIFT_LOCK_AUDIT_V12_10_31E.md'

test121031F:
	bash scripts/test_v12_10_31F.sh

report121031F:
	python scripts/drift_lock_audit_v12_10_31A.py || true
	@echo 'Report: release/drift_lock/DRIFT_LOCK_AUDIT_V12_10_31F.md'

test121031G:
	bash scripts/test_v12_10_31G.sh
