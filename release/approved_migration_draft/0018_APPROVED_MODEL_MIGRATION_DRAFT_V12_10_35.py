...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column("connector_key", sa.String(length=255), nullable=False),  # TODO: confirm type/nullability/default | executable TODO placeholder replaced with safe default
        sa.Column("seed_id", sa.Integer()),  # TODO: confirm FK target and migration order
        sa.Column("status", sa.String(length=255), nullable=False),  # TODO: confirm type/nullability/default | executable TODO placeholder replaced with safe default
    ...
    op.create_table(
        ...
        sa.Column("id", sa.Integer(), primary_key=True),  # TODO: confirm primary key
        sa.Column("subject_id", sa.Integer()),  # TODO: confirm FK target and migration order
        sa.Column("assertion_type", sa.String(length=255), nullable=False),  # TODO: confirm type/nullability/default | executable TODO placeholder replaced with safe default
        sa.Column("normalized_value", sa.Text()),  # TODO: confirm type/nullability/default
        sa.Column("confidence", sa.String(length=255), nullable=False),  # TODO: confirm type/nullability/default | executable TODO placeholder replaced with safe default
        sa.Column("validation_state", sa.String(length=255), nullable=False),  # TODO: confirm type/nullability/default | executable TODO placeholder replaced with safe default
    ...
    op.create_table(
        ...
        sa.Column("kind", sa.String(length=255), nullable=False),  # TODO: confirm type/nullability/default | executable TODO placeholder replaced with safe default
        sa.Column("path", sa.Text(), nullable=False),  # TODO: confirm type/nullability/default
        sa.Column("sha256", sa.String(length=255), nullable=False),  # TODO: confirm type/nullability/default | executable TODO placeholder replaced with safe default
        sa.Column("mime_type", sa.String(length=255)),  # TODO: confirm type/nullability/default | executable TODO placeholder replaced with safe default
    ...
    op.create_table(
        ...
        sa.Column("subject_id", sa.Integer()),  # TODO: confirm FK target and migration order
        sa.Column("run_id", sa.Integer()),  # TODO: confirm FK target and migration order
        sa.Column("observation_type", sa.String(length=255), nullable=False),  # TODO: confirm type/nullability/default | executable TODO placeholder replaced with safe default
        sa.Column("normalized_value", sa.Text()),  # TODO: confirm type/nullability/default
        sa.Column("confidence", sa.String(length=255), nullable=False),  # TODO: confirm type/nullability/default | executable TODO placeholder replaced with safe default
    ...
    op.create_table(
        ...
        sa.Column("id", sa.Integer(), primary_key=True),  # TODO: confirm primary key
        sa.Column("subject_id", sa.Integer()),  # TODO: confirm FK target and migration order
        sa.Column("seed_type", sa.String(length=255), nullable=False),  # TODO: confirm type/nullability/default | executable TODO placeholder replaced with safe default
        ...
        sa.Column("pii_hash", sa.String(length=255), nullable=False),  # TODO: confirm type/nullability/default | executable TODO placeholder replaced with safe default
        sa.Column("created_at", sa.DateTime(timezone=True)),  # TODO: confirm timezone/default
    )
    ...
    op.create_table(
        "spine_subjects",
        sa.Column("id", sa.Integer(), primary_key=True),  # TODO: confirm primary key
        sa.Column("label", sa.String(length=255)),  # TODO: confirm type/nullability/default | executable TODO placeholder replaced with safe default
        sa.Column("created_at", sa.DateTime(timezone=True)),  # TODO: confirm timezone/default
    )
    ...
    op.create_table(
        ...
        sa.Column("actor", sa.String(length=255)),  # TODO: confirm type/nullability/default | executable TODO placeholder replaced with safe default
        sa.Column("action", sa.String(length=255), nullable=False),  # TODO: confirm type/nullability/default | executable TODO placeholder replaced with safe default
    ...
    op.create_table(
        "retention_runs",
        sa.Column("id", sa.Integer(), primary_key=True),  # TODO: confirm primary key
        sa.Column("mode", sa.String(length=255), nullable=False),  # TODO: confirm type/nullability/default | executable TODO placeholder replaced with safe default
        sa.Column("status", sa.String(length=255), nullable=False),  # TODO: confirm type/nullability/default | executable TODO placeholder replaced with safe default
    ...
    op.create_table(
        ...
        sa.Column("id", sa.Integer(), primary_key=True),  # TODO: confirm primary key
        sa.Column("subject_id", sa.Integer()),  # TODO: confirm FK target and migration order
        sa.Column("job_type", sa.String(length=255), nullable=False),  # TODO: confirm type/nullability/default | executable TODO placeholder replaced with safe default
        sa.Column("status", sa.String(length=255), nullable=False),  # TODO: confirm type/nullability/default | executable TODO placeholder replaced with safe default
    ...
    op.create_table(
        ...
        sa.Column("edge_type", sa.String(length=255), nullable=False),  # TODO: confirm type/nullability/default | executable TODO placeholder replaced with safe default
        sa.Column("confidence", sa.String(length=255), nullable=False),  # TODO: confirm type/nullability/default | executable TODO placeholder replaced with safe default
        sa.Column("evidence_ref", sa.Text()),  # TODO: confirm type/nullability/default
        sa.Column("validation_state", sa.String(length=255), nullable=False),  # TODO: confirm type/nullability/default | executable TODO placeholder replaced with safe default
        sa.Column("payload_json", sa.Text(), nullable=False),  # TODO: confirm type/nullability/default
    ...
    op.create_table(
        ...
        sa.Column("id", sa.Integer(), primary_key=True),  # TODO: confirm primary key
        sa.Column("graph_id", sa.Integer()),  # TODO: confirm FK target and migration order
        sa.Column("entity_type", sa.String(length=255), nullable=False),  # TODO: confirm type/nullability/default | executable TODO placeholder replaced with safe default
        sa.Column("normalized_value", sa.Text(), nullable=False),  # TODO: confirm type/nullability/default
        sa.Column("node_ids_json", sa.Text(), nullable=False),  # TODO: confirm type/nullability/default
        sa.Column("confidence", sa.String(length=255), nullable=False),  # TODO: confirm type/nullability/default | executable TODO placeholder replaced with safe default
        sa.Column("state", sa.String(length=255), nullable=False),  # TODO: confirm type/nullability/default | executable TODO placeholder replaced with safe default
    ...
    op.create_table(
        ...
        sa.Column("id", sa.Integer(), primary_key=True),  # TODO: confirm primary key
        sa.Column("subject_id", sa.Integer()),  # TODO: confirm FK target and migration order
        sa.Column("conflict_type", sa.String(length=255), nullable=False),  # TODO: confirm type/nullability/default | executable TODO placeholder replaced with safe default
        sa.Column("severity", sa.String(length=255), nullable=False),  # TODO: confirm type/nullability/default | executable TODO placeholder replaced with safe default
        sa.Column("status", sa.String(length=255), nullable=False),  # TODO: confirm type/nullability/default | executable TODO placeholder replaced with safe default
    ...
    op.create_table(
        ...
        sa.Column("target_value", sa.String(length=255), nullable=False),  # TODO: confirm type/nullability/default | executable TODO placeholder replaced with safe default
        sa.Column("target_type", sa.String(length=255), nullable=False),  # TODO: confirm type/nullability/default | executable TODO placeholder replaced with safe default
        sa.Column("connector", sa.String(length=255), nullable=False),  # TODO: confirm type/nullability/default | executable TODO placeholder replaced with safe default
        sa.Column("status", sa.String(length=255), nullable=False),  # TODO: confirm type/nullability/default | executable TODO placeholder replaced with safe default
