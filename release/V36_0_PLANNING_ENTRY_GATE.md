...
The prior-program prerequisite is satisfied by `release/V35_6_PROGRAM_CLOSURE_CONTRACT.json`. v35 is closed, its final runtime merge is recorded, and automatic retry remains disabled.
