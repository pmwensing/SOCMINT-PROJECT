...
v35 is formally closed through `release/V35_6_PROGRAM_CLOSURE_CONTRACT.json`. The final v35 runtime merge is `f1b750241d03217aed0cb2a2fa255c7c9e5f37ee`. Automatic retry remains disabled; v36 consumes the completed governance controls without extending execution authority.
