# v12.10.31A Drift Lock Audit Report
...
- **warn_count**: `2`
- **framework**: `hybrid`
- **primary_entrypoint**: `scripts/drift_lock_audit_v12_10_31A.py`
- **alembic_heads**: `0017_v12_10_schema_reconciliation`
- **missing_v12_routes**: `8`
- **model_tables_missing_migrations**: `207`
- **version_unique_count**: `2`
- **report_json**: `/home/pmwens/Projects/SOCMINT-PROJECT/release/drift_lock/DRIFT_LOCK_AUDIT_V12_10_31A.json`
- **report_md**: `/home/pmwens/Projects/SOCMINT-PROJECT/release/drift_lock/DRIFT_LOCK_AUDIT_V12_10_31A.md`
  ...
  "candidates": [
    {
      ...
      "path": "scripts/drift_lock_audit_v12_10_31A.py",
      "score": 19
    },
    {
      "notes": [
    ...
    },
    {
      ...
      "path": "tests/test_dossier_finalization_closeout_export_verify_routes_v7_5_12.py",
      "score": 3
    },
    {
      "notes": [
      ...
      "path": "tests/test_dossier_finalization_master_delivery_export_bundle_routes_v7_5_14.py",
      "score": 3
    },
    {
      "notes": [
      ...
      "path": "tests/test_dossier_finalization_master_delivery_index_routes_v7_5_13.py",
      "score": 3
    },
    {
      "notes": [
      ...
      "path": "tests/test_operator_smoke_v9_6.py",
      "score": 3
    },
    {
      "notes": [
      ...
      "path": "tests/test_v10_24_final_delivery_workspace_routes.py",
      "score": 3
    },
    {
      "notes": [
      ...
      "path": "tests/test_v10_25_final_delivery_operator_console_routes.py",
      "score": 3
    },
    {
      "notes": [
      ...
      "path": "tests/test_v10_26_final_delivery_audit_trail_routes.py",
      "score": 3
    },
    {
      "notes": [
      ...
      "path": "tests/test_v10_27_final_delivery_evidence_capsule_routes.py",
      "score": 3
    },
    {
      "notes": [
      ...
      "path": "tests/test_v10_28_final_delivery_capsule_export_pack_routes.py",
      "score": 3
    },
    {
      "notes": [
      ...
      "path": "tests/test_v10_29_final_delivery_dashboard_api_routes.py",
      "score": 3
    },
    {
      "notes": [
      ...
      "path": "tests/test_v10_30_case_delivery_registry_routes.py",
      "score": 3
    },
    {
      "notes": [
      ...
      "path": "tests/test_v10_31_human_approval_gate_routes.py",
      "score": 3
    },
    {
      "notes": [
      ...
      "path": "tests/test_v10_32_productization_ux_routes.py",
      "score": 3
    },
    {
      "notes": [
      ...
      "path": "tests/test_v10_38_productization_ux_routes.py",
      "score": 3
    },
    {
      "notes": [
...
```json
{
  ...
  "models": {
    "model_files": [
      {
        "file": ".connector-tools/venv/lib/python3.13/site-packages/pandas/tests/io/test_sql.py",
        "tables": [
          "datetz",
          "iris",
          "temp_test",
      ...
      {
        "file": "scripts/drift_lock_audit_v12_10_31A.py",
        "tables": [
          "name"
        ]
      },
...
```json
{
  ...
  "route_files": [
    {
      "file": ".connector-tools/venv/lib/python3.13/site-packages/colorama/tests/ansitowin32_test.py",
      "routes": [
    ...
    {
      "file": ".connector-tools/venv/lib/python3.13/site-packages/colorama/tests/initialise_test.py",
      "routes": [
        "colorama.ansitowin32.enable_vt_processing",
        "colorama.ansitowin32.winapi_test",
        "colorama.initialise.AnsiToWin32",
        "colorama.initialise.atexit.register",
        "colorama.initialise.reset_all",
        "colorama.win32.SetConsoleTextAttribute"
      ]
    },
    {
      "file": ".connector-tools/venv/lib/python3.13/site-packages/colorama/tests/winterm_test.py",
      "routes": [
        "colorama.winterm.win32"
      ]
    },
    {
    ...
    {
      "file": ".connector-tools/venv/lib/python3.13/site-packages/numpy/tests/test_numpy_config.py",
      "routes": [
        "numpy.__config__._check_pyyaml"
      ]
    },
    {
      "file": ".connector-tools/venv/lib/python3.13/site-packages/setuptools/tests/test_bdist_deprecations.py",
      "routes": [
        "distutils.command.bdist_rpm.bdist_rpm"
      ]
    },
    {
      "file": ".connector-tools/venv/lib/python3.13/site-packages/setuptools/tests/test_build_clib.py",
      "routes": [
    ...
    },
    {
      ...
      "routes": [
        "src.socmint.enrichment.session.get"
      ]
    },
    {
      "file": "tests/test_main.py",
      "routes": [
        "src.socmint.main.run_instaloader",
        "src.socmint.main.run_maigret",
        "src.socmint.main.run_recon_ng",
        "src.socmint.main.run_registered_connector",
        "src.socmint.main.run_sherlock",
        "src.socmint.main.run_social_analyzer",
        "src.socmint.main.run_socialscan",
        "src.socmint.main.run_spiderfoot"
      ]
    },
    {
      "file": "tests/test_url_security.py",
      "routes": [
        "src.socmint.url_security.socket.getaddrinfo"
      ]
    },
    {
      "file": "var/venvs/v12_10_17/lib/python3.13/site-packages/colorama/tests/ansitowin32_test.py",
      "routes": [
        "colorama.ansitowin32.winapi_test",
        "colorama.ansitowin32.winterm"
      ]
    ...
    {
      "file": "var/venvs/v12_10_17/lib/python3.13/site-packages/colorama/tests/initialise_test.py",
      "routes": [
        "colorama.ansitowin32.enable_vt_processing",
        "colorama.ansitowin32.winapi_test",
        "colorama.initialise.AnsiToWin32",
    ...
    {
      "file": "var/venvs/v12_10_17/lib/python3.13/site-packages/colorama/tests/winterm_test.py",
      "routes": [
        "colorama.winterm.win32"
      ]
    },
    ...
    {
      "file": "var/venvs/v12_10_17/lib/python3.13/site-packages/setuptools/tests/test_bdist_deprecations.py",
      "routes": [
        "distutils.command.bdist_rpm.bdist_rpm"
      ]
    },
    {
      "file": "var/venvs/v12_10_17/lib/python3.13/site-packages/setuptools/tests/test_build_clib.py",
      "routes": [
        "setuptools.command.build_clib.newer_pairwise_group"
      ]
    }
...
### version_metadata: WARN

```json
{
  "expected_current": "12.10.31A",
  "items": {
    "pyproject.toml": "12.10.31A",
