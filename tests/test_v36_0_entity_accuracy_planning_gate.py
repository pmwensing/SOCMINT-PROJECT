...
def test_v36_0_defines_complete_entity_accuracy_roadmap():
    ...
    assert [item["slice"] for item in contract["roadmap"]] == [
        "v36.0", "v36.1", "v36.2", "v36.3", "v36.4",
        "v36.5", "v36.6", "v36.7", "v36.8",
    ]
...
def test_v36_0_is_planning_only_on_a_formally_closed_v35_baseline():
    ...
    assert gate["v35_program_closure_satisfied"] is True
    assert gate["v35_closure_contract"] == (
        "release/V35_6_PROGRAM_CLOSURE_CONTRACT.json"
    )
    assert gate["v35_final_runtime_merge_sha"] == (
        "f1b750241d03217aed0cb2a2fa255c7c9e5f37ee"
    )
    assert gate["v35_closure_merge_sha"] == (
        "f9a2af381f98e9919bc0913c7e67f3cc0b8deb22"
    )
...
def test_v36_0_reuses_authoritative_existing_layers():
    ...
    assert reuse["governance_execution"].startswith("closed v35")
