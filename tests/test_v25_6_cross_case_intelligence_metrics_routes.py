...
def test_v25_6_metrics_routes_apply_scope_and_render(tmp_path, monkeypatch):
    ...
    payload = {
        ...
        "metrics": {
            "candidate_volume": {"total": 3, "by_category": {"entities": 1}, "repeated_patterns": 1, "visible_cases": 2, "source_records": 8},
            "review_dispositions": {"total_reviews": 2, "reviewed_candidates": 2, "all_decisions": {"accept": 1, "reject": 1}, "latest_decisions": {"accept": 1, "reject": 1}, "review_coverage_percent": 66.67},
            "confirmation_conversion": {"confirmed_links": 1, "accepted_reviews": 1, "latest_accepted_reviews": 1, "candidate_to_confirmed_percent": 33.33, "accepted_to_registered_percent": 100.0},
            "graph_density": {"nodes": 4, "edges": 3, "density_percent": 50.0, "edges_per_node": 0.75, "average_degree": 1.5, "median_degree": 1.5, "graph_sha256": "g" * 64},
            "cross_case_reach": {"candidate_case_count": 2, "confirmed_case_count": 2, "visible_case_count": 2, "confirmed_case_reach_percent": 100.0, "average_cases_per_confirmed_link": 2.0, "median_cases_per_confirmed_link": 2.0, "maximum_cases_per_confirmed_link": 2},
            "source_occurrence_coverage": {"candidate_occurrences": 6, "confirmed_occurrences": 4, "coverage_percent": 66.67},
            "impact_breadth": {"analyzed_links": 1, "average_breadth_score": 7.0, "median_breadth_score": 7.0, "maximum_breadth_score": 7, "links": []},
            "analyst_throughput": {"analyst_count": 1, "total_reviews": 2, "analysts": [{"analyst": "alice", "review_count": 2, "active_review_days": 1, "reviews_per_active_day": 2.0, "disposition_counts": {"accept": 1, "reject": 1}}]},
            "confidence_indicators": {"score": 76.67, "band": "moderate", "components": {"review_coverage_percent": 66.67, "accepted_materialization_percent": 100.0, "source_occurrence_coverage_percent": 66.67, "cross_case_reach_percent": 100.0, "graph_support_percent": 50.0}, "interpretation": "operational_indicator_not_probability_or_factual_certainty"},
        },
        "metrics_sha256": "m" * 64,
...
def test_v25_6_release_note_and_no_migration():
    note = Path("release/V25_6_CROSS_CASE_INTELLIGENCE_METRICS_CONFIDENCE.md").read_text(encoding="utf-8")
    migrations = [
        path
