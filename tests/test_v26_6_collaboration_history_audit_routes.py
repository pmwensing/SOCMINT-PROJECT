...
def _payload():
    return {
        ...
        "history": [
            {
                ...
                "occurred_at": "2026-06-16T20:00:00+00:00",
                "actor": "supervisor",
                "affected_user": "paul",
                "case_id": "case-a",
                "previous_state": None,
        ...
        "current_collaboration_state": {
            "active_team": [
                {"case_id": "case-a", "user_identity": "paul", "role": "case_owner"}
            ],
            "current_owner": "paul",
            "open_requests": [],
            "pending_handoffs": [],
...
def test_v26_6_routes_require_login_scope_and_render(tmp_path, monkeypatch):
    ...
    for phrase in (
        b"Collaboration History and Audit",
        b"Current Collaboration State",
        b"Event Counts",
        b"Actor Counts",
        b"Ordered History",
        b"State SHA-256",
...
def test_v26_6_release_note_and_no_migration():
    note = Path("release/V26_6_COLLABORATION_HISTORY_AUDIT.md").read_text(
        encoding="utf-8"
    )
    migrations = [
        path
    ...
    for phrase in (
        "team assignments and revocations",
