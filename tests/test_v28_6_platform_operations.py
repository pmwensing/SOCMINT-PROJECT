...
from src.socmint.platform_operations_events_v28_6 import (
    acknowledge_incident,
    open_incident,
    resolve_incident,
)
from src.socmint.platform_operations_workspace_v28_6 import (
    build_platform_operations_workspace,
)
...
def test_v28_6_health_findings_incidents_and_history(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr(
        ...
        lambda: {
            ...
            "last_record_id": 11,
            "id_gap_count": 1,
            "id_gaps": [{"after_id": 5, "before_id": 7, "missing_count": 1}],
            "action_counts": {},
            "actor_counts": {},
            "latest_recorded_at": old,
        },
    )
    monkeypatch.setattr(
        workspace,
