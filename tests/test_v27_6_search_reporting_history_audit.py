from src.socmint.search_reporting_history_audit_v27_6 import (
    build_search_reporting_history_audit,
)
...
def test_v27_6_consolidates_orders_counts_and_current_state(monkeypatch):
        ...
        lambda: [
            {
                "action_record_id": 1,
                "recorded_by": "alice",
                "recorded_at": "2026-06-17T01:00:00+00:00",
        ...
        lambda: [
            {
                "action_record_id": 2,
                "recorded_by": "bob",
                "recorded_at": "2026-06-17T02:00:00+00:00",
                "source_action": "search_watchlist_run_recorded",
                "event_type": "run",
                ...
                "executed_access_scope": {"allowed_case_ids": ["case-a"]},
                "owner": "bob",
            }
        ],
    )
        ...
        lambda: [
            {
                ...
                "source_action": "search_report_package_generated",
    ...
    monkeypatch.setattr(
        audit, "current_watchlists", lambda: [{"watchlist_status": "active"}]
    )
    ...
    assert [item["family"] for item in result["events"]] == [
        "saved_view",
        "watchlist",
        "report_package",
    ]
...
def test_v27_6_filters_family_actor_and_limit(monkeypatch):
        ...
        lambda: [
            {
                ...
                "recorded_by": "bob",
                "recorded_at": "2026-06-17T02:00:00+00:00",
                "source_action": "search_watchlist_created",
                "event_type": "created",
            }
        ],
    )
    ...
    result = build_search_reporting_history_audit(
        families=["watchlist"], actors=["bob"], limit=1
    )
