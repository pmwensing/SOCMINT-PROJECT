...
def test_v24_5_calculates_volume_rates_durations_and_trends(monkeypatch):
        ...
        lambda now=None: {
            "reviewers": [
                ...
                },
                {
                    ...
                    "active_workload": 1,
                    "total_assigned": 4,
                    "average_assignment_age_hours": 5.0,
                },
            ]
        },
    )
        ...
        lambda: {
            ...
            "case-archived": [
                ...
                },
                {
                    ...
                    "occurred_at": "2026-06-11T14:00:00+00:00",
                    "details": {},
                },
            ],
            "case-reopened": [
    ...
    assert (
        result["stage_duration_metrics"]["retention_pending_archive"]["median_hours"]
        == 4.0
    )
...
def test_v24_5_handles_empty_portfolio_and_window_fallback(monkeypatch):
    ...
    monkeypatch.setattr(
        service, "build_case_status_stage_overview", lambda now=None: {"cases": []}
    )
    monkeypatch.setattr(
        service,
        "build_workload_assignment_monitoring",
        lambda now=None: {"reviewers": []},
    )
    monkeypatch.setattr(
