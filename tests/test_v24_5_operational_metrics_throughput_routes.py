...
def test_v24_5_metrics_api_and_dashboard(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr(
        routes,
        "build_blocked_overdue_case_queue",
        lambda: {
            "schema": "socmint.portfolio_blocked_overdue_queue.v24_3",
            "version": "v24.3.0",
            "status": "clear",
            "thresholds": {
                "stage_overdue_hours": 72.0,
                "assignment_overdue_hours": 48.0,
            },
            "counts": {
                "total": 0,
                "critical": 0,
        ...
        "reviewer_throughput": [
            {
                ...
                "average_assignment_age_hours": 10.0,
            }
        ],
        "rates": {
            "blocked_rate_percent": 20.0,
            "overdue_rate_percent": 20.0,
            "closure_archive_conversion_percent": 66.67,
            "reopen_rate_percent": 50.0,
        },
        "trend_windows": [
            {
                "days": 7,
                "window_start": "2026-06-08T22:00:00+00:00",
                "window_end": "2026-06-15T22:00:00+00:00",
                "event_count": 10,
                "active_case_count": 5,
                "stage_throughput": {"closed": 3},
                "closure_completions": 3,
                "archive_completions": 2,
                "reopen_completions": 1,
            }
        ],
        "source_records_mutated": False,
...
def test_v24_5_release_note_and_no_migration():
    note = Path("release/V24_5_OPERATIONAL_METRICS_THROUGHPUT.md").read_text(
        encoding="utf-8"
    )
    migrations = [
        path
