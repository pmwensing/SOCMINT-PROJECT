...
def test_v21_6_routes_ui_and_note(tmp_path, monkeypatch):
    ...
    payload = {
        "status": "ready", "case_id": "case-alpha", "subject_id": 42,
        "export_package_id": "dossier-export-1", "export_package_sha256": "a" * 64,
        "dossier_content": {"section_count": 1, "sections": []},
        "citation_catalog": [], "source_manifest": {},
        "approval_record": {"approval_id": "approval-1"},
        "integrity": {"content_sha256": "b" * 64}, "latest_export": None,
    }
    ...
    assert client.get("/api/v1/dossier-assembly/case-alpha/final-export?subject_id=42").status_code == 200
