...
from src.socmint.collection_operations_workspace_v29_0 import (
    build_collection_operations_workspace,
)
...
def test_v29_0_aggregates_collection_jobs_outputs_and_provenance(monkeypatch):
    ...
    assert {
        ...
        "collection_job_stale",
        "duplicate_collection_runs",
        "collection_without_requesting_actor",
    }.issubset(keys)
