...
from socmint.dossier_finalization_export_verify_routes_v7_5_3 import register_dossier_finalization_export_verify_routes
...
def test_json_packet_route_returns_verified_report():
    client = app_client()
    response = post_json(client, "/api/v1/dossier-builder/v3/intelligence/finalization/export/verify", {"packet": ready_packet()})
...
def test_raw_packet_request_shape_works():
    client = app_client()
    response = post_json(client, "/api/v1/dossier-builder/v3/intelligence/finalization/export/verify", ready_packet())
...
def test_zip_base64_route_returns_verified_report():
    ...
    client = app_client()
    response = post_json(client, "/api/v1/dossier-builder/v3/intelligence/finalization/export/verify-zip", {"zip_base64": encoded})
...
def test_invalid_base64_returns_failed_report_not_500():
    client = app_client()
    response = post_json(client, "/api/v1/dossier-builder/v3/intelligence/finalization/export/verify-zip", {"zip_base64": "not base64!!!"})
...
def test_missing_base64_returns_failed_report_not_500():
    client = app_client()
    response = post_json(client, "/api/v1/dossier-builder/v3/intelligence/finalization/export/verify-zip", {})
