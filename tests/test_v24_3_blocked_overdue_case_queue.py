...
def test_v24_3_prioritizes_blocked_and_overdue_cases(monkeypatch):
            ...
            "cases": [
                {
                    ...
                    "links": {
                        "case_review": "/case-intelligence-review/case-critical",
                        "dossier_assembly": "/dossier-assembly/case-critical",
                        "closure_workspace": "/case-closure/case-critical",
                        "closure_history": "/case-closure/case-critical/history",
                    },
                },
                {
                    "case_id": "case-medium",
                    ...
                    "links": {
                        "case_review": "/case-intelligence-review/case-medium",
                        "dossier_assembly": "/dossier-assembly/case-medium",
                        "closure_workspace": "/case-closure/case-medium",
                        "closure_history": "/case-closure/case-medium/history",
                    },
                },
            ]
        },
        ...
        lambda: {
            "cases": [
                ...
                },
                {
                    ...
                    "stage_duration_hours": 80.0,
                    "blocked": False,
                    "blocking_reason": None,
                    "blockers": [],
                    "next_expected_action": "complete_case_analysis",
                },
            ]
        },
    )
    monkeypatch.setattr(
        service,
        "build_workload_assignment_monitoring",
        lambda: {
            "entries": [
                {
                    "case_id": "case-critical",
    ...
    assert result["queue"][0]["remediation_links"]["supervisor_queue"].endswith(
        "case_id=case-critical"
    )
...
def test_v24_3_clear_queue_and_threshold_fallback(monkeypatch):
    ...
    monkeypatch.setattr(
        service, "build_portfolio_operations_dashboard", lambda: {"cases": []}
    )
    monkeypatch.setattr(
        service, "build_case_status_stage_overview", lambda: {"cases": []}
    )
    monkeypatch.setattr(
        service, "build_workload_assignment_monitoring", lambda: {"entries": []}
    )
