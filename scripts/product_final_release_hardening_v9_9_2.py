...
def main() -> int:
    ...
    md_path = Path("release/V9_9_2_FINAL_RELEASE_HARDENING_REPORT.md")
    storage_path = Path("storage/product_qa/V9_9_2_FINAL_RELEASE_HARDENING_REPORT.json")

    json_path.write_text(json.dumps(report, indent=2))
    storage_path.write_text(json.dumps(report, indent=2))

    md = [
        "# v9.9.2 Final Release Publisher Hardening Report",
        "",
