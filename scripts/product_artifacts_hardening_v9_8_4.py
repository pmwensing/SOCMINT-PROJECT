...
def main() -> int:
    ...
    checks = [
        ...
        run(
            "product-artifacts-smoke-v9-8-4",
            [sys.executable, "scripts/product_artifacts_smoke_v9_8_4.py"],
        ),
    ]
    ...
    report = {
        ...
        "next_action": "Merge v9.8.4 into master"
        if status == "pass"
        else "Fix artifact browser failures before merge.",
    }
    ...
    storage_path = Path(
        "storage/product_qa/V9_8_4_ARTIFACT_BROWSER_HARDENING_REPORT.json"
    )
