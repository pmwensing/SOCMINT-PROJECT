...
WORK_ROOT="var/test_v12_10_15"
VENV_DIR="$WORK_ROOT/.venv"
DB_PATH="$WORK_ROOT/socmint_v12_10_15.db"
DATA_DIR="$WORK_ROOT/data"
LOG_FILE="$WORK_ROOT/socmint.log"
STATUS_JSON="$REPORT_ROOT/socmint_v12_10_15_fresh_db_gate_status.json"
STATUS_MD="$REPORT_ROOT/socmint_v12_10_15_fresh_db_gate_status.md"
...
payload = {
  "schema": "socmint.release.fresh_db_gate.v12_10_15",
  "version": "12.10.15",
...
echo "[+] SOCMINT v12.10.15 Fresh DB CI Release Gate"
echo "[+] 1. git clean checkout"
if [ "$CI_MODE" = "true" ]; then
  echo "[+] SOCMINT_CI_MODE=true, allowing GitHub Actions checkout metadata state"
else
  git status --short
...
: > "$STATUS_MD"
section "SOCMINT v12.10.15 Fresh DB CI Release Gate"
...
export SOCMINT_SECRET_KEY="test-v12-10-15-secret-key-000000000000000000000000"
...
python scripts/runtime_route_release_gate_v12_10_15.py
pass_line "runtime route release gate passed"

section "8-15. subject-to-dossier E2E and RC report exports"
python scripts/subject_to_dossier_e2e_v12_10_15.py
pass_line "subject-to-dossier E2E release gate passed"

record_json "pass" "GO" "SOCMINT v12.10.15 fresh DB CI release gate passed"
cat >> "$STATUS_MD" <<EOF
...
echo
echo "[+] SOCMINT v12.10.15 fresh DB CI release gate PASSED"
