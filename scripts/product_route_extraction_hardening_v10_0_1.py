...
def main() -> int:
    ...
    checks = [
        ...
        run("route-extraction-smoke-v10-0-1", [sys.executable, "scripts/product_route_extraction_smoke_v10_0_1.py"]),
    ]
    ...
    report = {
        ...
        "next_action": "Merge and tag v10.0.1 route extraction phase 1" if status == "pass" else "Fix v10.0.1 route extraction failures before merge.",
    }
    ...
    storage_path = Path("storage/product_qa/V10_0_1_ROUTE_EXTRACTION_HARDENING_REPORT.json")
