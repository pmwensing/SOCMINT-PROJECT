...
def register_delivery_receipt_feedback_panels_routes_v33_4(app):
    @app.get(
        "/api/v1/dissemination-governance/cases/"
        "<case_id>/delivery-receipt-feedback-panels"
    )
    def get_case_delivery_receipt_feedback_panels_v33_4(case_id: str):
