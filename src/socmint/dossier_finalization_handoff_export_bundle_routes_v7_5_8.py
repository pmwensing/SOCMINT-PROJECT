...
from .dossier_finalization_handoff_export_bundle_v7_5_8 import build_handoff_export_bundle
...
def register_dossier_finalization_handoff_export_bundle_routes(app):
    @app.post("/api/v1/dossier-builder/v3/intelligence/finalization/certificate/handoff-index/export")
    ...
    @app.post("/api/v1/dossier-builder/v3/intelligence/finalization/certificate/handoff-index/export.zip")
