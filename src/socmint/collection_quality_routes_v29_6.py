...
from .collection_product_review_routes_v29_7 import (
    register_collection_product_review_routes_v29_7,
)
...
def register_collection_quality_routes_v29_6(app):
    ...
    def collection_quality_workspace_get_v29_6():
        ...
        if not actor_is_administrator(actor):
            return render_template(
                "collection_quality_v29_6.html",
                title="Collection Quality, Trust, and Dossier Contribution",
                payload={
                    "status": "forbidden",
                    "error": "administrator required",
                    "quality_assessments": [],
                    "dossier_contribution_reviews": [],
        ...
        return render_template(
            "collection_quality_v29_6.html",
            title="Collection Quality, Trust, and Dossier Contribution",
            payload=build_collection_quality_workspace(),
        )
    ...
    @app.post(
        "/api/v1/collection-operations/evidence/<artifact_id>/quality-assessments"
    )
    ...
    @app.post(
        "/api/v1/collection-operations/quality-assessments/<quality_assessment_id>/dossier-contribution"
    )
