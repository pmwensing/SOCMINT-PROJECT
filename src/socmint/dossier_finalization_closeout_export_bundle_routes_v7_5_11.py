...
from .dossier_finalization_closeout_export_bundle_v7_5_11 import build_closeout_export_bundle
from .dossier_finalization_closeout_export_bundle_v7_5_11 import build_closeout_export_zip
from .dossier_finalization_closeout_export_bundle_v7_5_11 import safe_closeout_bundle_name
...
def register_dossier_finalization_closeout_export_bundle_routes(app):
    @app.post("/api/v1/dossier-builder/v3/intelligence/finalization/closeout-report/export")
    ...
    @app.post("/api/v1/dossier-builder/v3/intelligence/finalization/closeout-report/export.zip")
