...
from .dossier_export_certification_index_routes import register_dossier_export_certification_index_routes
...
def register_production_release_routes(app):
    ...
    register_dossier_export_certification_routes(app)
    register_dossier_export_certification_index_routes(app)
