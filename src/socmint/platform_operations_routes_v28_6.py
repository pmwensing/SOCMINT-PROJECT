...
from .administration_product_review_routes_v28_7 import (
    register_administration_product_review_routes_v28_7,
)
...
def register_platform_operations_routes_v28_6(app):
    ...
    def platform_operations_workspace_get_v28_6():
        ...
        if not actor_is_administrator(actor):
            return render_template(
                "platform_operations_v28_6.html",
                title="Platform Health, Jobs, and Operational Audit",
                payload={
                    "status": "forbidden",
        ...
        return render_template(
            "platform_operations_v28_6.html",
            title="Platform Health, Jobs, and Operational Audit",
            payload=build_platform_operations_workspace(),
        )
    ...
    def api_platform_operations_workspace_get_v28_6():
        ...
        return jsonify(
            build_platform_operations_workspace(stale_after_hours=stale_after_hours)
        )
