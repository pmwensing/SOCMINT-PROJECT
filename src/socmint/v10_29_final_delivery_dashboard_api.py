    ...
    return [
        {
            ...
            "data": {
                ...
                "bundle_name": pack.get("bundle_name"),
            },
        },
        {
            ...
            "detail": "Final delivery evidence capsule is available."
            if pack.get("capsule_id")
            else "Evidence capsule is missing.",
            "data": {
                "capsule_id": pack.get("capsule_id"),
        ...
        },
        {
            ...
            "detail": "Operator receipt is available."
            if receipt.get("audit_id")
            else "Operator receipt is missing.",
            "data": {
                "audit_id": receipt.get("audit_id"),
                "export_available": receipt.get("export_available"),
            },
        },
        {
        ...
        },
        {
            ...
            "detail": "Capsule export pack is available."
            if pack.get("pack_id")
            else "Capsule export pack is missing.",
            "data": {
                "pack_id": pack.get("pack_id"),
                "required_file_count": pack.get("file_count"),
            },
        },
    ]
...
def build_final_delivery_dashboard_api_from_pack(
    pack: dict[str, Any],
) -> dict[str, Any]:
...
def build_final_delivery_dashboard_api_from_request(
...
def build_final_delivery_dashboard_actions_from_request(
    payload: dict[str, Any],
) -> list[dict[str, Any]]:
    return list(
        build_final_delivery_dashboard_api_from_request(payload).get("api_actions")
        or []
    )
