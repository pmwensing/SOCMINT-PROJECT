...
from .dossier_finalization_certificate_bundle_verify_routes_v7_5_6 import (
...
def _zip_index_from_payload(payload: dict) -> dict:
    ...
    return build_handoff_index_from_zip_bytes(
        zip_bytes, bundle_name=bundle_name, operator=operator, notes=notes
    )
